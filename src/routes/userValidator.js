...
const ValidationRegister = [
    ...
    body('apartmentFloor').trim().isLength({ min:1 }).withMessage('El campo Piso no puede estar vacio'),
    body('apartmentUnit').trim().isLength({ min:1 }).withMessage('El campo Dpto. no puede estar vacio'),
